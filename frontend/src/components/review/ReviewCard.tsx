...
export function ReviewCard({ review }: { review: Review }) {
  return (
    <div className="border-b border-slate-100 py-6 last:border-none">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <h4 className="mt-2.5 font-semibold text-secondary">{review.title}</h4>
          ...
          <button className="mt-3 flex items-center gap-1.5 text-xs font-medium text-slate-400 hover:text-primary cursor-pointer">
            ...
            <div className="mt-4 flex gap-2.5 rounded-xl bg-slate-50 p-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <p className="text-sm font-semibold text-secondary">Response from the owner</p>
                  <span className="text-xs text-slate-400">{formatDate(review.ownerReply.createdAt)}</span>
                </div>
